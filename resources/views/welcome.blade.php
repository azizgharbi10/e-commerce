...
<head>
    ...
    <title>Bienvenue - Boutique</title>
...
<body>
    <div class="container">
        <div class="signup-card">
            ...
            <div class="mb-4">
                <button type="button" class="btn btn-signup" data-bs-toggle="modal" data-bs-target="#signupForm">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header border-0">
                            <h5 class="modal-title" style="color: var(--dark-brown); font-weight: 700;">Créer un compte</h5>
                        ...
                        <div class="modal-body">
                            <form action="{{ route('register') }}" method="POST">
                                ...
                                <button type="submit" class="btn btn-signup" style="margin-top: 15px;">
                                    Créer mon compte
                                </button>
                            </form>
                        </div>
